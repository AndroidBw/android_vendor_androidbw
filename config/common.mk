...
# Branding to AndroidBw

PRODUCT_VERSION_MAJOR = 10
PRODUCT_VERSION_MINOR = 0

LINEAGE_VERSION := AndroidBw-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)
LINEAGE_DISPLAY_VERSION := AndroidBw-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(LINEAGE_BUILD)
